...
const JobToggleBtn = ({ activeTab, setActiveTab }) => {
  return (
    <section className='rounded-2xl bg-secondary-bg text-sm md:text-base font-medium mt-5 text-white flex w-3/4 md:w-3/5 2xl:w-1/2 transition-all duration-300'>
      <button
